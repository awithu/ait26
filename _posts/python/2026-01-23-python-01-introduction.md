...
안녕하세요! 파이썬 강의를 시작합니다. 파이썬은 정말 배우기 쉬우면서도 강력한 언어예요. 프로그래밍을 처음 시작하시는 분들에게 특히 추천하는 언어입니다!
...
오늘은 파이썬이 무엇인지, 그리고 어떻게 설치하는지 배웠어요. 정말 쉽죠?

다음 강의에서는 **변수와 데이터 타입**에 대해 배울 거예요. 변수는 프로그래밍의 기본이에요. 마치 상자에 물건을 넣고 꺼내는 것처럼, 데이터를 저장하고 사용하는 방법을 배울 거예요.
